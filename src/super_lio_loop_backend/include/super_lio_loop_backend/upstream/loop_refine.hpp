...
#include "super_lio_loop_backend/upstream/voxel_map.hpp"
...
inline vector<double> gba_eigen_value_array;
inline double gba_min_eigen_value;
inline double gba_voxel_size;
